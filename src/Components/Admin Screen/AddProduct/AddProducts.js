    ...
    render() {
        ...
        return (
            <div className="add-product-container">
                        ...
                        {({handleSubmit,handleChange,errors,setFieldTouched,touched})=>(
                            <form onSubmit={handleSubmit}>
                                    ...
                                    <div className="product-image-main-container">
                                       {allproductImages.length!==3 && <label className="product-images-container" htmlFor="product-image">
                ...
                <h5 className="pick-4-images" ref={this.productImageError}>Pick <span>3</span> images</h5>
            </div>
        );
    }
}
